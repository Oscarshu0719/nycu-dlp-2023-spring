...
\lstset{
    ...
    tabsize=4,
	columns=flexible, 
	emph=[0]{board, isomorphic, weight, iso_last, state}, 
	emphstyle=[0]\color{blue},
	emph=[1]{mirror, rotate, indexof, at, estimate, update, update_episode, pop_back, assign, 
		back, reward, before_state, value, max, size, after_state, set, set_value, select_best_move}, 
	emphstyle=[1]\color{gray},
	emph=[2]{size_t, vector, numeric_limits, uint64_t}, 
...
\newcommand{\reportTitle}{Lab2: Temporal Difference Learning}
