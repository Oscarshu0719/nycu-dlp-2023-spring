...
\lstset{
    ...
    tabsize=4,
	columns=flexible, 
	emph=[0]{__init__, True, torch}, 
	emphstyle=[0]\color{blue},
	emph=[1]{nn, Union, None, Optional, transforms, np, plt, PIL}, 
	emphstyle=[1]\color{gray},
	emph=[2]{self, ReLU, Sequential, MSELoss, Conv2d, BatchNorm2d, Module, MaxPool2d, AdaptiveAvgPool2d, Flatten, Linear, Dropout, RandomHorizontalFlip, RandomVerticalFlip, Resize, ToTensor, Compose, DataLoader, ndarray, figure, title, xlabel, ylabel, savefig, close, Image}, 
...
\newcommand{\reportTitle}{Lab7: Let’s Play DDPM}
\newcommand{\labTitle}{Lab7: Let’s Play DDPM}
